/* The code block below Only Applies to Node.js - This Demonstartes 
    re-useability of JS code in both Back-end and Front-end! #isomorphic */
/* istanbul ignore if */
if (typeof module !== 'undefined' && module.exports) {
  var QUnit = require('qunitjs'); //require QUnit node.js module 
  // alias the QUnit.test method so we dont have to change all our tests
  var test = QUnit.test; //store a copy of QUnit.test 
